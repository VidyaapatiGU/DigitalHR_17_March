...
<template>
  <div class="page-wrapper">
    <div class="page-header-bar"><h5>Add Client</h5></div>
          ...
          <form v-auto-animate class="form-container">
            ...
            <div class="w-100 d-flex justify-content-center align-items-center">
              ...
              >
                ...
                <router-link to="/manage/clients" v-if="documentUploaded == false">
                  <button
                    type="button"
                    class="btn-submit"
                  >
...
export default {
  ...
  async created() {
    ...
    if (this.userId) {
      try {
        console.log('created after current');
        const userRes = await axiosClient.get(`/api/v1/user/get/${this.form.user_id}`);
        console.log(userRes);
  ...
  methods: {
    ...
    async getCurrent() {
      try {
        ...
        console.log('User is: ', this.form.user_id);
      } catch (err) {
        console.log('error: ', err);
        this.$router.push('/login');
      }
